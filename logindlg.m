...
function [Login,Password]=logindlg(defUser,defPsw)
...
% Texts
gui.login_text = uicontrol(gui.main,'Style','text','FontSize',8,'HorizontalAlign','left','Units','characters','String','Domain Account','Position',[1 7.65 20 1]);
...
% Edits
gui.edit1 = uicontrol(gui.main,'Style','edit','FontSize',8,'HorizontalAlign','left','BackgroundColor','white','Units','characters','String',defUser,'Position',[1 6.02 33 1.7]);
